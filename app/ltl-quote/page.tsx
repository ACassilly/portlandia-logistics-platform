    ...
    <main className="bg-white">
      ...
      <section className="pt-10">
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          <h1 className="mt-4 text-balance text-[44px] font-semibold leading-[1.04] text-pl-dark sm:text-[54px]">
            <span>Get a Freight Quote</span>
            <span className="text-pl-green"> You Can Trust</span>
          </h1>
          <p className="mt-4 max-w-[760px] text-pretty text-[15px] leading-7 text-pl-text sm:text-[16px]">
          ...
          <div className="mt-10 grid items-start gap-8 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <div className="relative aspect-[16/10] overflow-hidden rounded-card bg-[#0f5b3f] shadow-card">
                <img
                  src="/images/trucks.svg"
                  alt="Truck fleet"
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-card border border-pl-border-2 bg-white p-6 shadow-card">
                ...
                <div className="mt-4 text-[13px] leading-6 text-[#2d2d2d]">
                  <span className="font-semibold">From</span> Miami, FL 33130{" "}
                  <span className="font-semibold">To</span> Florida, NY 10921
                </div>
                ...
                <div className="mt-4 overflow-hidden rounded-lg border border-pl-border-2">
                  {[
                    ...
                    <div key={k} className="flex items-center justify-between gap-6 border-b border-pl-border-2 px-4 py-3 last:border-b-0">
        ...
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          >
            <div className="flex flex-col gap-6 border-b border-pl-border-2 px-7 py-6 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="text-[12px] font-semibold tracking-[0.12em] text-[#7a7a7a]">GET YOUR BEST RATE</div>
                <div className="mt-1 text-[20px] font-semibold text-pl-dark">LTL Quote Request</div>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="-mx-2 overflow-x-auto px-2">
                        <table className="min-w-[980px] w-full border-separate border-spacing-0 overflow-hidden rounded-lg border border-pl-border-2">
                          <thead className="bg-[#fafafa]">
                            <tr className="text-left text-[11px] font-semibold tracking-[0.12em] text-[#6f6f6f]">
                              {["QTY", "HANDLING UNIT", "L", "W", "H", "WEIGHT", "FREIGHT CLASS", "HAZMAT"].map((h) => (
                                ...
                                <tr key={it.id} className="text-[13px] text-pl-dark">
                                  <td className="border-b border-pl-border-2 px-3 py-3">
                                    <input
                                      ...
                                      min={1}
                                      value={it.qty}
                                      onChange={(e) => updateItem(it.id, { qty: Math.max(1, n(e.target.value)) })}
                                    />
                                  </td>
                                  <td className="border-b border-pl-border-2 px-3 py-3">
                                    <select
                                      ...
                                      onChange={(e) => updateItem(it.id, { handlingUnit: e.target.value as HandlingUnit })}
                                    >
                                      {(
                                        [
                                          "Pallet",
                      ...
                      <div className="mt-6 grid gap-3 rounded-lg border border-pl-border-2 bg-[#fbfbfb] p-4 md:grid-cols-3">
                        <div>
                          <div className="text-[11px] font-semibold tracking-[0.12em] text-[#6f6f6f]">TOTAL WEIGHT</div>
                          <div className="mt-1 text-[15px] font-semibold text-pl-dark">
                            {Math.round(totals.totalWeight)} lbs
                          </div>
                        </div>
                        <div>
                          <div className="text-[11px] font-semibold tracking-[0.12em] text-[#6f6f6f]">TOTAL DENSITY</div>
                          <div className="mt-1 text-[15px] font-semibold text-pl-dark">
                      ...
                      <div className="grid gap-4 md:grid-cols-12">
                        ...
                        <div className="md:col-span-12">
                          ...
                          <textarea
                            ...
                            onChange={(e) => setConditions((c) => ({ ...c, specialInstructions: e.target.value }))}
                        ...
                        <div className="md:col-span-12">
                          <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-pl-border-2 bg-[#fbfbfb] px-4 py-3">
                            <input
                              ...
                              onChange={(e) => setConditions((c) => ({ ...c, termsAccepted: e.target.checked }))}
                            ...
                            <div>
                              ...
                              <div className="mt-1 text-[13px] leading-6 text-pl-text">
                                I confirm the shipment details are accurate and agree to the carrier and brokerage terms.
                              </div>
                            </div>
                          </label>
                        </div>
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 text-[13px] text-[#6f6f6f]">
                            {pickup.city}, {pickup.state} {pickup.zip} → {delivery.city}, {delivery.state} {delivery.zip}
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              // Light prefill for the shipper/consignee step.
                              setShipper((s) => (s.city || s.state || s.zip ? s : { ...s, city: pickup.city, state: pickup.state, zip: pickup.zip }));
                              setConsignee((c) =>
                                c.city || c.state || c.zip ? c : { ...c, city: delivery.city, state: delivery.state, zip: delivery.zip },
                              );
                              setStep(3);
                              scrollToQuoteCard();
                            }}
                    ...
                    <div>
                      ...
                      {selectedRate && (
                        <div className="mt-2 text-[13px] text-[#6f6f6f]">
                          ...
                          <span className="font-semibold text-pl-green">{formatUsd(selectedRate.totalPrice)}</span>
                        </div>
                      )}
                    </div>
      ...
      <section id="faqs" className="pt-16">
        <div className="mx-auto max-w-[1200px] px-6">
          <div className="text-center">
            <div className="text-[12px] font-semibold tracking-[0.12em] text-[#7a7a7a]">FAQs</div>
            <h2 className="mt-2 text-balance text-[34px] font-semibold leading-[1.08] text-pl-dark">Questions, answered</h2>
          </div>
